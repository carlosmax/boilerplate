...
// Import Images
import amazon from '@/presentation/assets/images/clients/amazon.svg'
import walmart from '@/presentation/assets/images/clients/walmart.svg'
import lenovo from '@/presentation/assets/images/clients/lenovo.svg'
import paypal from '@/presentation/assets/images/clients/paypal.svg'
import shopify from '@/presentation/assets/images/clients/shopify.svg'
import verizon from '@/presentation/assets/images/clients/verizon.svg'
          ...
          <Row>
            <Col lg={12}>
              <div className='text-center mt-5'>
                <h5 className='fs-20'>
                  Trusted <span className='text-primary text-decoration-underline'>by</span> the
                  {`world's`} best
                </h5>
                <Swiper
                  slidesPerView={4}
