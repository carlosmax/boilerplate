...
import { sideBarStyleState, menuToggleState } from '@/presentation/components'

const NavHeader: React.FC = () => {
  const [toggle, setToggle] = useState(false)
  const sideBarStyle = useRecoilValue(sideBarStyleState)
  const setMenuToggle = useSetRecoilState(menuToggleState)
        ...
        <>
          ...
          >
            <g id='Group_26' data-name='Group 26' transform='translate(-134 -40.641)'>
              <text
                id='Hotel_Admin_Dashboard'
                data-name='Hotel Admin Dashboard'
              ...
              <path
                ...
                transform='translate(134 54.316)'
                fill='#212121'
              />
            </g>
          </svg>
