...
const TwoColumnLayout: React.FC = (props: any) => {
  ...
  function activateIconSidebarActive(id: string): void {
    const menu = document.querySelector(
      "#two-column-menu .simplebar-content-wrapper a[data-subitems='" + id + "'].nav-icon"
    )
    if (menu !== null) {
  ...
  const removeActivation = (items: any[]): void => {
    ...
    activeIconItems.forEach(item => {
      item.classList.remove('active')
      const id = item.getAttribute('data-subitems')
